      ...
      <div className='flex justify-center flex-col w-4/5 h-full mx-auto mt-8 lg:mt-32'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-12'>
          ...
          <div>
            ...
            <p >Atuei na concepção e aprimoramento da experiência do usuário no e-commerce da Delly's Food Service, garantindo uma interface intuitiva, acessível e eficiente para milhares de clientes do setor alimentício. Minhas principais atividades incluíram:</p>
